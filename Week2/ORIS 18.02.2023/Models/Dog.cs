namespace ORIS_18._02._2023.Models
{
    public class Dog
    {
        ...
        public Dog(string imgUrl, string descr, string shortDescr, Family fam)
        {
            ImgUrl = imgUrl;
            Description = descr;
